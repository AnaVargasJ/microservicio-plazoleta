...
public class PedidoHandler implements IPedidoHandler {
    ...
    @Override
    public void asignarPedidoPin(HttpServletRequest request, Long idPedido, String estado, Long idUsuario, String pin, String correo) {
        String token = request.getHeader(AUTHORIZATION_HEADER);
        pedidoServicePort.asignarPedido(token,idPedido,estado, idUsuario, pin, correo);
    }
